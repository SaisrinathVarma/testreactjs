...
import JsonData from "./data.json"; // Importing sample data from a JSON file
...
function Pagination() {
  ...
  const [users, setUsers] = useState(JsonData.slice(0, 51)); // Initial user data, sliced to limit the number of displayed users
  ...
  return (
    <div className="App ">
      ...
      <ReactPaginate className="flex space-x-4 text-blue-600"
